  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="border-b bg-card">
        <div className="py-4 flex items-center justify-between px-4 md:px-6">
      ...
      <main className="h-[calc(100vh-73px)] flex flex-col md:flex-row">
        ...
        <div className="flex-1 flex flex-col order-1 md:order-2">
          ...
          {config.image && (
            <div className="p-4 bg-background md:flex md:justify-center">
              <div className="bg-card border rounded-lg shadow-md p-2 w-full md:w-auto">
                <CanvasToolbar
                  activeTool={activeTool}
                  zoom={zoom}
